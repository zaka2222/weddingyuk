...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="index.php?page=about">Tentang Kami</a></li>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card about-card">
                <div class="card-body">
                    <h5 class="card-title">Edit Data Tentang Kami</h5>
                    ...
                    <form class="row g-3" method="POST" action="../action.php?act=edit-about" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            <label class="form-label">Text tentang kami</label>
