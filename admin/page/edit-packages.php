...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="index.php?page=packages">Produk</a></li>
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="../action.php?act=edit-packages" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            ...
                            <p class="example">Gunakan Fitur <code>Bullet List</code> <i class="fa-solid fa-list-ul"></i> untuk menaruh list Produk.</p>
