...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="assets/img/favicon/123.png">
...
<body>
    ...
    <img src="assets/img/favicon/123.png" alt="Logo" width="100" height="100" style="background: transparant;">
</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mx-auto">
                    ...
                    <a class="nav-link mx-2" href="#package">Paket</a>
                    <a class="nav-link mx-2" href="blog/">Artikel</a>
                    <a class="nav-link mx-2" href="#client">Testimonal</a>
    ...
    <div id="home" class="background-banner">
        <div class="hero-text">
            <div class="text-center">
                ...
                <h1 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">Pernikahan Indah <br> Dimulai Dengan Perencanaan yang teliti</h1>
                <p class="sub-text" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">Mewujudkan Pernikahan Anda dengan<br>Elegansi dan Kesempurnaan</p><br>
                <a href="#features" class="main-btn" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="900">Daftarkan diri anda sekarang</a>
            </div>
        </div>
    </div>
    ...
    <section id="features" class="features py-5">
        <div class="container">
            <div class="heading-text text-center mb-5">
                <p class="text-p" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">&#129321; Mengapa Memilihh Kami?</p>
                <h4 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">fitur Layanan Terbaik Yang Kami Sediakan</h4>
                <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">Memberikan fitur Pelayanan yang baik bagi calon pengantin merupakan Prioritas bagi kami</p>
            </div>
    ...
    <section id="package" class="package py-5">
        <div class="container">
            <div class="heading-text text-center mb-4">
                <p class="text-p">&#128184; Paket Murah, Uang mudah</p>
                <h4>Paket Terbaik Harga Terbaik Untuk Anda</h4>
            </div>
            <div class="row justify-content-center">
                <?php
                // jalankan query untuk menampilkan semua data diurutkan berdasarkan nim
            ...
            <div class="row justify-content-center">
                ...
                ?>
                    ...
                    <div class="blog-item col-md-3 card">
                        ...
                        <div class="card-body">
                            <div class="author">
                                <p><span><?php echo date('M d Y', strtotime($row['blog_date'])); ?></span> / weddingyuk</p>
                            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="footer-item col-lg-3 col-md-6 mb-4">
                    <h3>WeddingYuk</h3>
                    <p>
                        Jl. Dalong Sukaharja<br />
                        Kota Ketapang, kabupaten MHU<br />
                        Kalimantan barat, Indonesia <br /><br />
                        <strong>Phone:</strong> +6289373787982<br />
                        <strong>Email:</strong> weddingYuk@gmail.com<br />
                    </p>
                </div>
                <div class="footer-item col-lg-3 col-md-6 mb-4">
                    <h4>Useful Links</h4>
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right"></i> <a href="#about">Tentang Kami</a></li>
                        <li><i class="fa fa-angle-right"></i> <a href="#gallery">Gallery</a></li>
                        <li><i class="fa fa-angle-right"></i> <a href="blog/index.php">Artikel</a></li>
    ...
    <section id="copyright" class="copyright">
        <div class="container text-center content-card">
            <p>
                ©Copyright 2022 <span>WeddingYuk</span>. All Rights Reserved
            </p>
